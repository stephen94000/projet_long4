 ...
 * @author hamza94000
 */
public class ErrorType extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
